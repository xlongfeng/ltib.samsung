...
#make g2d test
make -C fsl_drv/g2d/test/ clean
make -C fsl_drv/g2d/test/
make -C fsl_drv/g2d/test/overlay_test/ clean
make -C fsl_drv/g2d/test/overlay_test/ KERNEL_DIR=$KERNELDIR
unset SDK_BUILD
...
#install g2d test binaries
install -d $RPM_BUILD_ROOT/%{pfx}/opt/fsl_samples/g2d/
cp -f fsl_drv/g2d/test/g2d_test $RPM_BUILD_ROOT/%{pfx}/opt/fsl_samples/g2d/
install -d $RPM_BUILD_ROOT/%{pfx}/opt/fsl_samples/g2d/overlay_test/
cp -f fsl_drv/g2d/test/overlay_test/g2d_overlay_test $RPM_BUILD_ROOT/%{pfx}/opt/fsl_samples/g2d/overlay_test/

#install g2d test source code
install -d $RPM_BUILD_ROOT/%{pfx}/usr/share/imx-gpu/g2d/test/
cp -f fsl_drv/g2d/test/*.c $RPM_BUILD_ROOT/%{pfx}/usr/share/imx-gpu/g2d/test/
cp -f fsl_drv/g2d/test/*.sh $RPM_BUILD_ROOT/%{pfx}/usr/share/imx-gpu/g2d/test/
cp -f fsl_drv/g2d/test/Makefile $RPM_BUILD_ROOT/%{pfx}/usr/share/imx-gpu/g2d/test/

install -d $RPM_BUILD_ROOT/%{pfx}/usr/share/imx-gpu/g2d/test/overlay_test/
cp -f fsl_drv/g2d/test/overlay_test/*.c $RPM_BUILD_ROOT/%{pfx}/usr/share/imx-gpu/g2d/test/overlay_test/
cp -f fsl_drv/g2d/test/overlay_test/*.sh $RPM_BUILD_ROOT/%{pfx}/usr/share/imx-gpu/g2d/test/overlay_test/
cp -f fsl_drv/g2d/test/overlay_test/Makefile $RPM_BUILD_ROOT/%{pfx}/usr/share/imx-gpu/g2d/test/overlay_test/

install -d $RPM_BUILD_ROOT/%{pfx}/usr/include/
cp -af driver/build/sdk/include/* $RPM_BUILD_ROOT/%{pfx}/usr/include
cp -af fsl_drv/g2d/include/* $RPM_BUILD_ROOT/%{pfx}/usr/include
